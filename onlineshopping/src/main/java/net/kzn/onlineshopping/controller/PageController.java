...
public class PageController {
	...
	public ModelAndView index() {
		...
		// passing the object list of categories
	...
	/* For handlling URL Query String */
	...
	/*
	 * For handling dymic URL
	 * 
	 * @RequestMapping(value = "/test/{greeting}") //greeting is dynamic variable
	 * for all method// public ModelAndView test(@PathVariable("greeting")String
	 * greeting) { if(greeting == null) { greeting = "Hello There"; } ModelAndView
	 * mv = new ModelAndView("page"); mv.addObject("greeting", greeting); return mv;
	 * }
	 */
}
